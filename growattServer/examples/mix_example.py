...
#Write List of plants to file
with open('plant_list.txt', 'w') as f:
  for plant in plant_list['data']:
    plant_id = plant['plantId']
    plant_name = plant['plantName']
    f.write("%s - %s\n"%(plant_id, plant_name))

#Write the plant data from plant_list into file
with open('plant_list.json', 'w') as f:
  f.write(plant_list['data']) 

#Write the total data from plant_list into file
with open('plant_list_totals.json', 'w') as f: 
  f.write(plant_list['totalData'])
